...
namespace FinalAssessment
{
    public class BackStroke : Event
    {
        ...
        public BackStroke(int eventNo, string venue, int venueID, string eventDateTime, double record, string eventType, int distance, double winningTime, bool newRecord) : base(eventNo, venue, venueID, eventDateTime, record)
        {
